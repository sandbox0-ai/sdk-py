...
class ClientVolumesMixin:
    ...
    def create_volume(self: "Client", request: CreateSandboxVolumeRequest) -> SandboxVolume:  # type: ignore[misc]
    ...
    def list_volumes(self: "Client") -> list[SandboxVolume]:  # type: ignore[misc]
        resp = get_api_v1_sandboxvolumes.sync_detailed(client=self._api)
        data = ensure_data(resp, SuccessSandboxVolumeListResponse)
        return data

    # Backward-compatible alias.
    def list_volume(self: "Client") -> list[SandboxVolume]:  # type: ignore[misc]
        return self.list_volumes()  # type: ignore[attr-defined]

    def get_volume(self: "Client", volume_id: str) -> SandboxVolume:  # type: ignore[misc]
    ...
    def list_volume_snapshots(self: "Client", volume_id: str) -> list[Snapshot]:  # type: ignore[misc]
    ...
    def get_volume_snapshot(self: "Client", volume_id: str, snapshot_id: str) -> Snapshot:  # type: ignore[misc]
    ...
    def delete_volume_snapshot(self: "Client", volume_id: str, snapshot_id: str) -> SuccessDeletedResponse:  # type: ignore[misc]
    ...
    def restore_volume_snapshot(self: "Client", volume_id: str, snapshot_id: str) -> SuccessRestoreResponse:  # type: ignore[misc]
