...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/sandboxes/{id}/contexts/{ctx_id}/input".format(
            id=id,
            ctx_id=ctx_id,
        ),
    }
...
) -> Optional[Union[ErrorEnvelope, SuccessWrittenResponse]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ErrorEnvelope, SuccessWrittenResponse]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ErrorEnvelope, SuccessWrittenResponse]
    """
