...
from ...models.team_delete_conflict_response import TeamDeleteConflictResponse
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 409:
        response_409 = TeamDeleteConflictResponse.from_dict(response.json())
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ErrorEnvelope, SuccessMessageResponse, TeamDeleteConflictResponse]
    """
