...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/sandboxvolumes/{id}/files/list".format(
            id=id,
        ),
        "params": params,
    }
...
) -> Optional[Union[ErrorEnvelope, SuccessFileListResponse]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ErrorEnvelope, SuccessFileListResponse]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ErrorEnvelope, SuccessFileListResponse]
    """
