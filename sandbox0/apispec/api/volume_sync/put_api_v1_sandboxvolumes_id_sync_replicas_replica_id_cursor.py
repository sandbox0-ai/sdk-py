...
from ...models.update_sync_replica_cursor_request import UpdateSyncReplicaCursorRequest
...
def _get_kwargs(
    ...
    replica_id: str,
    *,
    body: UpdateSyncReplicaCursorRequest,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/api/v1/sandboxvolumes/{id}/sync/replicas/{replica_id}/cursor".format(
            id=id,
