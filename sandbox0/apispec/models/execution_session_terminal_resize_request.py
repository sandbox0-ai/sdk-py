...
T = TypeVar("T", bound="ExecutionSessionTerminalResizeRequest")


@_attrs_define
class ExecutionSessionTerminalResizeRequest:
    """
    Attributes:
        rows (int):
        cols (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        execution_session_terminal_resize_request = cls(
            rows=rows,
            cols=cols,
            expected_attempt_id=expected_attempt_id,
        )

        execution_session_terminal_resize_request.additional_properties = d
        return execution_session_terminal_resize_request
