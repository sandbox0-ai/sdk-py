...
T = TypeVar("T", bound="SuccessSandboxPreviewResponse")


@_attrs_define
class SuccessSandboxPreviewResponse:
    """
    Attributes:
        success (bool):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        success_sandbox_preview_response.additional_properties = d
        return success_sandbox_preview_response
