...
class NodeSelectorTerm:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for match_expressions_item_data in (_match_expressions or []):
            match_expressions_item = NodeSelectorRequirement.from_dict(match_expressions_item_data)
        ...
        for match_fields_item_data in (_match_fields or []):
            match_fields_item = NodeSelectorRequirement.from_dict(match_fields_item_data)
