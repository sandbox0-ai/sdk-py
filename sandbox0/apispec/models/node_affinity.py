...
class NodeAffinity:
    ...
    required_during_scheduling_ignored_during_execution: Union[Unset, 'NodeSelector'] = UNSET
    preferred_during_scheduling_ignored_during_execution: Union[Unset, list['PreferredSchedulingTerm']] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_required_during_scheduling_ignored_during_execution,  Unset):
            ...
            required_during_scheduling_ignored_during_execution = NodeSelector.from_dict(_required_during_scheduling_ignored_during_execution)
        ...
        for preferred_during_scheduling_ignored_during_execution_item_data in (_preferred_during_scheduling_ignored_during_execution or []):
            preferred_during_scheduling_ignored_during_execution_item = PreferredSchedulingTerm.from_dict(preferred_during_scheduling_ignored_during_execution_item_data)
