...
if TYPE_CHECKING:
    ...
    from ..models.static_username_password_source_spec import (
...
class CredentialSourceWriteSpec:
    ...
    static_tls_client_certificate: Union[
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_static_tls_client_certificate, Unset):
            ...
            static_tls_client_certificate = (
                StaticTLSClientCertificateSourceSpec.from_dict(
                    _static_tls_client_certificate
                )
            )
        ...
        if isinstance(_static_username_password, Unset):
            ...
            static_username_password = StaticUsernamePasswordSourceSpec.from_dict(
