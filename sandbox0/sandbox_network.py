...
class SandboxNetworkMixin:
    ...
    def get_network_policy(self: "Sandbox") -> SandboxNetworkPolicy:  # type: ignore[misc]
    ...
    def update_network_policy(self: "Sandbox", policy: SandboxNetworkPolicy) -> SandboxNetworkPolicy:  # type: ignore[misc]
